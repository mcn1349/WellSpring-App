...
{
    public class JourneyExercise_WorkoutViewModel
        : MvxViewModel
    {
        ...
        public async void Adding()
        {
            ...
            exer.ExerciseType = "Workout";

            bool NameCorrect = (exer.Name != null && exer.Name != "");

            bool LapsCorrect = true;
            int LapsVal = 0;
            LapsCorrect = int.TryParse(Laps, out LapsVal);
            exer.Laps = LapsVal;
            ...
            bool correctValues = (NameCorrect && LapsCorrect && SetsCorrect && DurationCorrect && BurnedCorrect);
            if (correctValues)
            {
